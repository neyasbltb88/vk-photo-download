...
function () {
  ...
  _createClass(PhotoDownload, [{
    ...
    value: function _updateBtn(elem) {
      ...
      this.image_data = window.Photoview.genData(window.cur.pvCurPhoto); // Проверим, не был ли новый url ранее уже скачен

      this._checkLoadedUrl(); // Обновим ссылку в кнопке
