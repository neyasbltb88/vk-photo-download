...
function () {
  function PhotoDownloadTemplates() {
    ...
    this.template_html = (0, _templateHtml.default)(this.sel, this.timings, this.icons);
    this.template_css = (0, _templateCss.default)(this.sel, this.timings, this.icons);
  } // constructor
