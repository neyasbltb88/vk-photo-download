...
function () {
  function PhotoDownload() {
    ...
    this.imgContainer_class = 'pv_image_wrap'; // Объект с описанием обработчиков
    ...
    this.style_id = 'PhotoDownloadStyle'; // Объект, генерирующий разноцветные иконки
  ...
  _createClass(PhotoDownload, [{
    ...
    value: function _updateBtn(elem) {
      var parent = elem.closest('.' + this.imgContainer_class); // Если в родительском контейнере еще нет кнопки
      ...
      var btn = parent.querySelector('.PhotoDownload_btn');
      var size = parent.querySelector('.PhotoDownload_size');
      this.last_image_data = window.Photoview.genData(cur.pvCurPhoto); // Если ссылка в кнопке не та, которая нужна сейчас
    ...
    value: function _createDownloadContainer(elem) {
      var parent = elem.closest('.' + this.imgContainer_class);
    ...
    key: "_createInnerElems",
    value: function _createInnerElems() {
      return (
        /* html */
...
},{"downloadjs":3}],2:[function(require,module,exports){
"use strict";
...
},{"./modules/photo-download":1}],3:[function(require,module,exports){
