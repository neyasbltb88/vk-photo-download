  ...
  _createClass(PhotoDownload, [{
    ...
    value: function _watchTrigger(event) {
      ...
      triggers.forEach(function (trigger) {
        ...
        var compliance = _this2._checkComplianceTarget(target, trigger, event.type); // Если цели события нет в объекте обработчиков, но в обработчике указано, 
        ...
        if (!compliance && trigger.child) {
          ...
          _this2._checkComplianceChild(target, trigger, event.type);
        }
      });
    ...
    value: function _checkComplianceTarget(target, trigger, type) {
      if (type === 'click') {
    ...
    value: function _checkComplianceChild(target, trigger, type) {
      if (type === 'click') {
