...
function () {
  ...
  _createClass(HandlersManager, [{
    ...
    value: function _startTimer(e) {
      ...
      if (e.which !== 1) return false; // Настройки закрыты
...
function () {
  ...
  _createClass(PhotoDownload, [{
    ...
    value: function _updateBtn(elem) {
      ...
      var btn = this.wrap.querySelector('.' + this.selectors.get('btn.btn')); // Получаем из недр ВК информацию о максимальной версии открытой в просмотрщике картинки

      var image_data = window.Photoview.genData(window.cur.pvCurPhoto); // Обновим ссылку в кнопке
    ...
    value: function init() {
      ...
      this._injectCSS(); // Восстанавливаем сохраненное в LocalStorage состояние
